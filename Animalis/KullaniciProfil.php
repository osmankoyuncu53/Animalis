...
include "netting/baglan.php";  
    ...
    $Sorgu = $VeritabaniBaglantisi->prepare("SELECT * FROM gecmissiparis INNER JOIN urunler ON gecmissiparis.Urun_ID=urunler.Urun_ID WHERE Kullanici_ID=:kullanici_id");
    $Sorgu->execute(array('kullanici_id'=>$_SESSION['Kullanici_ID']));
?>
<?php if (isset($_SESSION["Kullanici"])) { ?>
    ...
    <head>
        ...
        <title><?php echo DonusumleriGeriDondur($SiteAdi . " | " . $KullaniciAd); ?> Hesabım </title><!-- title -->
                ...
                <div class="row">
                    <div class="col-md-3  col-md-99">
                        <div class="nav flex-column nav-pills" role="tablist" aria-orientation="vertical">
                            ...
                            <a class="nav-link" id="orders-nav" data-toggle="pill" href="#Siparis" role="tab"><i class="fa fa-shopping-bag"></i>Siparişlerim</a>
                            ...
                            <a class="nav-link" href="KullaniciCikis.php"><i class="fa fa-sign-out-alt"></i>Çıkış Yap</a>
                        </div>
                    </div>
                    <div class="col-md-9">
                        <div class="tab-content">
                            <div class="tab-pane fade show active" id="dashboard-tab" role="tabpanel" aria-labelledby="dashboard-nav">
                                <h4>Hesabım</h4>
                                <p>
                                    Merhaba <b><?php echo $Ad ?></b> Hesabım bölümünden hesap ayarlarını ve kart bilgilerini güncelleye bilirsiniz.
                                </p>
                                <p> Sitemize <?php echo TarihBul($KayitTarihi); ?> Tarihinde kayıt olmuş bulunmaktasınız. </p>
                            </div>
                            <div class="tab-pane fade" id="Siparis" role="tabpanel" aria-labelledby="orders-nav">
                                <h4>Siparişlerim</h4>
                                <div class="table-responsive">
                                    <table class="table table-bordered">
                                    
                                        <thead class="thead-dark">
                                            <?php while($oku=$Sorgu->fetch(PDO::FETCH_ASSOC)) { ?> 
                                            <tr>
                                                <td><b>No<b></td>
                                                <td><b>Ürün<b></td>
                                                <td><b>Fiyat<b></td>
                            ...
                            <div class="tab-pane fade" id="Adres" role="tabpanel" aria-labelledby="address-nav">
                                ...
                                ?>
                                    ...
                                    <p> Merhaba <b><?php echo $KullaniciAd ?></b> Bu bölümde adres bilgilerini Güncelleye bilir silebilir ve düzenleye bilirsin. </p>
                            ...
                            <div class="tab-pane fade" id="Bilgilerim" role="tabpanel" aria-labelledby="account-nav">
                                <form action="KullaniciBilgilerimiGuncelle.php" method="POST">
                                    <h4>Üyelik Bilgilerim</h4>
                                    <div class="row">

                                        <div class="col-md-6">
                                            <p class="forms-user">Kullanıcı Adı</p>
                                            <input class="form-control" type="text" name="KullaniciAdi" value="<?php echo $KullaniciAd; ?>" placeholder="Kullanici Ad">
                                        </div>

                                        <div class="col-md-6">
                                            <p class="forms-user">E-mail</p>
                                            <input class="form-control" type="text" name="EmailAdresi" value="<?php echo $EmailAdresi; ?>" placeholder="Email Adresi">
                                        </div>

                                        <div class="col-md-6">
                                            <p class="forms-user">Ad</p>
                                            <input class="form-control" type="text" name="Ad" value="<?php echo $Ad; ?>" placeholder="Ad">
                                        </div>

                                        <div class="col-md-6">
                                            <p class="forms-user">Soyad</p>
                                            <input class="form-control" type="text" name="Soyad" value="<?php echo $Soyad; ?>" placeholder="soyad">
                                        </div>
                                        <div class="col-md-6">
                                            <p class="forms-user">Telefon Numarası</p>
                                      ...
                                      <!--  <div class="col-md-6">
                                            <p class="forms-user">Dogum Tarihi</p>
                                            <input class="form-control" type="date" name="DogumTarihi" value="<?php echo $DogumTarihi; ?>">
                                        </div>-->
                                        <div class="col-md-12">
