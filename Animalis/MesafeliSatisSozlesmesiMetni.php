...
<head>
    ...
    <title><?php echo DonusumleriGeriDondur($SiteTitle) ; ?> | Mesafeli Satış Sözleşmesi </title>    <!-- title -->
...
<body>
    ...
    <div class="container">
        <div class="row">
        <div class="col-lg-82">
            <h1 class="blg">Mesafeli Satış Sözleşmesi</h1>
            <p><?php echo DonusumleriGeriDondur($MesafeliSatisSozlesmesiMetni); ?> </p>
