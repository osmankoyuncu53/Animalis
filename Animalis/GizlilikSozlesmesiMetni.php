...
<head>
    ...
    <title><?php echo DonusumleriGeriDondur($SiteTitle) ; ?> | Gizlilik Sözleşmesi </title>    <!-- title -->
...
<body>
    ...
    <div class="container">
        <div class="row">
        <div class="col-lg-82">
            <h1 class="blg">Gizlilik Sözleşmesi</h1>
            <p><?php echo DonusumleriGeriDondur($GizlilikSozlesmesiMetni); ?> </p>
