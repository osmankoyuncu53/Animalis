...
<head>
    ...
    <title><?php echo DonusumleriGeriDondur($SiteTitle) ; ?> | Kullanım Koşulları </title>    <!-- title -->
...
<body>
    ...
    <div class="container">
        <div class="row">
        <div class="col-lg-82">
            <h1 class="blg">Kullanım Koşulları</h1>
            <p><?php echo DonusumleriGeriDondur($KullanimKosullariMetni ); ?> </p>
