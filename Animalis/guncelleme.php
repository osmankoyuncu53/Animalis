                        ...
                        <div class="card-body" style="box-shadow: 1px 1px 10px 10px #dedede;border-radius: 5px;">
                            <form class="form-horizontal form-material" action="netting/islem.php" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="form-group mb-4">
                                    <label class="col-md-12 p-0"><b>Ürün Adı</b></label>

                                    <div class="col-md-12 border-bottom p-0">
                                        <input style="font-size:13px;" type="text" name="urun_ad" value="<?php echo $oku['Urun_Ad'];?>" class="form-control p-0 border-0">
										 </div>
                                </div>

                                <div class="form-group mb-4">
                                    <label class="col-md-12 p-0"><b>Ürün Miktarı</b></label>
                                        <div class="col-md-12 border-bottom p-0">
                                            <input style="font-size:13px;" type="text" name="urun_miktar" value="<?php echo $oku["Urun_Miktar"];?>" class="form-control p-0 border-0">
										</div>
                                </div>

                                <div class="form-group mb-4">
                                    <label class="col-md-12 p-0"><b>Ürün Fiyatı</b></label>
									<input style="font-size:13px;" type="text" name="urun_fiyat" value="<?php echo $oku["Urun_Fiyat"];?>" class="form-control p-0 border-0">
                                </div>

                                <div class="form-group mb-4">
                                    <label class="col-md-12 p-0"><b>Ürün Kategori</b></label>

                                    <select name="urun_kategori" class="form-control p-0 border-0">
										<option style="background-color: green; color:white;" value="<?php echo $oku['Urun_Kategori'];?>"><?php echo $oku['Urun_Kategori'];?></option>
										<option value="Kopek">Kopek</option>
										<option value="Kedi">Kedi</option>
										<option value="Kedi">Balık</option>
									</select>
								</div>
								...
								<div class="form-group mb-4">
									...
									<select name="urun_tur" class="form-control p-0 border-0">
										<option style="background-color: green; color:white;" value="<?php echo $oku['Urun_Tur'];?>"><?php echo $oku['Urun_Tur'];?></option>
								...
								<div class="form-group mb-4">
                                    <label class="col-md-12 p-0"><b>Ürün Açıklaması</b></label>

                                    <div class="col-md-12 border-bottom p-0">
                                        <input type="text" name="urun_aciklama" value="<?php echo $oku['Urun_Aciklama'];?>"class="form-control p-0 border-0">
										 </div>
                                </div>

                                <div class="form-group mb-4">
                                        <label class="col-md-12 p-0"><b>Ürün Resim</b></label>
                                        
										<div class="col-md-12 border-bottom p-0">
											<td><input id="inputFile" type="file" name="urun_resim" class="form-control p-0 border-0"></td> 
                                        </div>
                                </div>
								...
								<div class="form-group mb-4">
                                    <label class="col-md-12 p-0"><b>Ürün Resim</b></label>
                                        <div class="col-md-12 border-bottom p-0">
											<img class="img" id="imgLogo" src="img/<?php echo $oku['Urun_Resim'];?>" style="width:116px; height:111px" >
										</div>
                                </div>
                                    ...
                                    <div class="form-group mb-4">
                                        <div class="col-sm-12">
                                            ...
                                            <button name="urun_guncelle" type="submit" class="btn btn-success">Güncelle</button>
                                        </div>
                                    </div>
