            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-12 col-xlg-9 col-md-12">
                        <div class="card">
                            <div class="card-body">
                                <form class="form-horizontal form-material" action="siteAyarlariSonuc.php" method="POST" enctype="multipart/form-data">
                                    <div class="form-group mb-4">
                                        <label class="col-md-12 p-0">Site Başlık</label>
                                        <div class="col-md-12 border-bottom p-0">
                                            <input type="text" name="SiteTitle" value="<?php echo DonusumleriGeriDondur($SiteTitle) ?>" class="form-control p-0 border-0"> </div>
                                    </div>
                                    <div class="form-group mb-4">
                                        <label class="col-md-12 p-0">Site Description</label>
                                        <div class="col-md-12 border-bottom p-0">
                                            <input type="text" name="SiteDescription" value="<?php echo DonusumleriGeriDondur($SiteDescription ) ?>" class="form-control p-0 border-0">
                                        </div>
                                    </div>
                                    <div class="form-group mb-4">
                                        <label class="col-md-12 p-0">Site Keywords</label>
                                        <div class="col-md-12 border-bottom p-0">
                                            <input type="text" name="SiteKeywords" value="<?php echo DonusumleriGeriDondur($SiteKeywords) ?>" class="form-control p-0 border-0">
                                        </div>
                                    </div>
									<div class="form-group mb-4">
                                        <label class="col-md-12 p-0">SiteCopyrightMetni</label>
                                        <div class="col-md-12 border-bottom p-0">
                                            <input type="text" name="SiteCopyrightMetni" value="<?php echo DonusumleriGeriDondur($SiteCopyrightMetni) ?>" class="form-control p-0 border-0">
                                        </div>
                                    </div>
                                    <div class="form-group mb-4">
                                        <label class="col-md-12 p-0">Site Email Adresi</label>
                                        <div class="col-md-12 border-bottom p-0">
                                            <input type="text" name="SiteEmailAdresi" value="<?php echo DonusumleriGeriDondur($SiteEmailAdresi) ?>" class="form-control p-0 border-0"> </div>
                                    </div>
                                    <div class="form-group mb-4">
                                        <label class="col-md-12 p-0">Site Email Sifresi</label>
                                        <div class="col-md-12 border-bottom p-0">
                                            <input type="text" name="SiteEmailSifresi" value="<?php echo DonusumleriGeriDondur($SiteEmailSifresi) ?>" class="form-control p-0 border-0"> </div>
                                    </div>
                                    <div class="form-group mb-4">
                                        <label class="col-md-12 p-0">Site Adres</label>
                                        <div class="col-md-12 border-bottom p-0">
                                            <input type="text" name="SiteAdres" value="<?php echo DonusumleriGeriDondur($SiteAdres) ?>" class="form-control p-0 border-0"> </div>
                                    </div>
                                    <div class="form-group mb-4">
                                        <label class="col-md-12 p-0">Site Telefon</label>
                                        <div class="col-md-12 border-bottom p-0">
                                            <input type="text" name="SiteTelefon" value="<?php echo DonusumleriGeriDondur($SiteTelefon) ?>" class="form-control p-0 border-0"> </div>
                                    </div>
                                    <div class="form-group mb-4">
                                        <label class="col-md-12 p-0">Site Logo</label>
                                        <div class="col-md-12 border-bottom p-0">
                                            <input type="file" name="SiteLogo"  value="<?php echo DonusumleriGeriDondur($SiteLogo) ?>" class="form-control p-0 border-0"> </div>
                                    </div>
                                    <div class="form-group mb-4">
                                        <label class="col-md-12 p-0">Site Favicon</label>
                                        <div class="col-md-12 border-bottom p-0">
                                            <input type="file" name="Favicon"  value="<?php echo DonusumleriGeriDondur($Favicon) ?>" class="form-control p-0 border-0"> </div>
                                    </div>
                                    <div class="form-group mb-4">
                                        <label class="col-md-12 p-0">Site Reklam</label>
                                        <div class="col-md-12 border-bottom p-0">
                                            <input type="file" name="SiteReklam"  value="<?php echo DonusumleriGeriDondur($SiteReklam) ?>" class="form-control p-0 border-0"> </div>
                                    </div>
                                    <div class="form-group mb-4">
                                        <div class="col-sm-12">
